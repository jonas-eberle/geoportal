...
class LayersAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (None, {
            ...
            'fields': ('ogc_link', 'ogc_layer', 'ogc_type', 'ogc_imageformat', 'ogc_getfeatureinfo', 'ogc_time', 'legend_graphic', 'legend_url', 'wmts_matrixset', 'wmts_resolutions', 'sos_default_field')
        }),
        (None, {
            'classes': ('suit-tab', 'suit-tab-dataset',),
            'fields': ('dataset_contact_new', 'date_create', 'language', 'characterset', 'format', 'equi_scale', 'representation_type')
        }),
        (None, {
