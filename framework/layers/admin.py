...
class LayersAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (None, {
            ...
            'fields': ('ogc_link', 'ogc_layer', 'ogc_type', 'ogc_imageformat', 'ogc_attribution', 'ogc_getfeatureinfo', 'ogc_time', 'legend_graphic', 'legend_url', 'legend_colors', 'wmts_matrixset', 'wmts_resolutions', 'wmts_multiply', 'wmts_tilesize', 'wmts_projection', 'wmts_prefix_matrix_ids', 'sos_default_field')
        }),
        (None, {
