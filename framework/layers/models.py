...
class Layer(models.Model):    
    ...
    ogc_attribution = models.CharField("Attribution", max_length=200, blank=True, null=True, help_text="Attribution / Copyright. To add a link use the following syntax (http://www.adress.de, name)")
